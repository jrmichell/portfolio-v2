      ...
      <div className="flex justify-center items-center mt-1 mx-4 gap-8">
        ...
        <div className="navbar flex justify-end items-center gap-2">
          <div className="navbar-end">
            <label className="relative md:flex justify-end items-center swap swap-rotate md:mx-4 mx-12">
              ...
              {/* sun icon */}
              <svg
                className="absolute swap-on fill-current w-8 h-8"
              ...
              {/* moon icon */}
              <svg
                className="absolute swap-off fill-current w-8 h-8"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              >
